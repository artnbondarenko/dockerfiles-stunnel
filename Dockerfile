...
LABEL org.label-schema.name="jmif/stunnel" \
      org.label-schema.description="Stunnel on Alpine" \
      org.label-schema.url="https://github.com/jmif/dockerfiles-stunnel/" \
      org.label-schema.usage="https://github.com/jmif/dockerfiles-stunnel/blob/master/README.md" \
      org.label-schema.vcs-url="https://github.com/jmif/dockerfiles-stunnel/" \
      org.label-schema.vendor="https://github.com/jmif" \
